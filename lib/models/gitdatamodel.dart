...
//
//     final gitData = gitDataFromJson(jsonString);

import 'dart:convert';

GitData gitDataFromJson(String str) => GitData.fromJson(json.decode(str));

String gitDataToJson(GitData data) => json.encode(data.toJson());
...
class GitData {
  ...
  factory GitData.fromJson(Map<String, dynamic> json) => GitData(
